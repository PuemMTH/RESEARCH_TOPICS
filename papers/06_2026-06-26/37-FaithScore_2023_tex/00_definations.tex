...
\usepackage{wrapfig} % Include this line in the preamble
\usepackage{picinpar}
...
\newcommand{\ours}{\textsc{FaithScore}}
\newcommand{\ourstitle}{\textsc{FaithScore}}
\newcommand{\oursEst}{\textsc{FaithScore}$_\text{Est}$}
% \newcommand{\ours}{\textsc{Multimodal FAithScore}}
% \newcommand{\ourstitle}{\textsc{Multimodal FAithScore}}
% \newcommand{\oursEst}{\textsc{Multimodal FAithScore}$_\text{Est}$}
%\newcommand{\estimator}{FSEstimator}
% \newcommand{\ourslong}{\textbf{Faithfulness} in Individual Element \textbf{Score}}
\newcommand{\ourslong}{\textbf{Faith}fulness to Atomic Image Facts \textbf{Score}}
\newcommand{\ourScore}{\textsc{Multimodal FAithScore}}
\newcommand{\ourScores}{\textsc{Multimodal FAithScore}s}
...
\newcommand{\xd}[1]{\textcolor{red}{\textbf{XD:} #1}}
% \newcommand{\rl}[1]{\textcolor{red}{\textbf{RL:} #1}}

\usepackage{booktabs} 


\newcommand{\pearson}{\textsc{Pearson's $r$}}
\newcommand{\spearman}{\textsc{Spearman’s $\rho$}}
\newcommand{\kendall}{\textsc{Kendall’s $\tau$}}