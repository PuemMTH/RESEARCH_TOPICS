...
\newcommand{\journal}[1]{} % text that is too long for short conf paper, but would be good for journal
...
\newtheorem{property2}{Property}%[section]  
...
% \renewcommand{\thesubsubsection}{\hspace{-1em}\bfseries{{\arabic{section}.\arabic{subsection}.\arabic{subsubsection}}}\hspace{0em}}
